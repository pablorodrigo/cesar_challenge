...
fun main() {
    ...
    println(isPartialPermutation("you", "yuo"))
    println(isPartialPermutation("probably", "porbalby"))
    println(isPartialPermutation("despite", "desptie"))
    println(isPartialPermutation("moon", "nmoo"))
    println(isPartialPermutation("misspellings", "mpeissngslli"))

}

fun isPartialPermutation(word: String, jumbledWord: String): Boolean {
